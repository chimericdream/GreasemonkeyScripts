...
// @grant       none
// ==/UserScript==
!function(e,n,a,r){"use strict";var s=a(function(){var n=e('[class*="PrePlaySummary-summary-"] > [class*="CollapsibleText-contentTransition-"] > [class*="Measure-container-"]');if(0===n.length&&(n=e('[class*="PrePlaySummary-summary-"] > .false > [class*="Measure-container-"]')),0!==n.length){var a=n.html();if(a=a.replace(/<\/p><p>/gi,"\n").replace(/<\/?p>/gi,"").replace(/<div.+><\/div>/gi,""),!n.hasClass("pmd-markdownified")){var s=new r.Converter,i=s.makeHtml(a);e("p",n).remove(),n.contents().filter(function(){return 3==this.nodeType}).remove(),n.prepend(i),n.addClass("pmd-markdownified")}}},500);n.addEventListener("DOMNodeInserted",s,!1)}(jQuery,window,window.fnDebounce,this.showdown);